...
class Display {
    public:
        ...
        [[nodiscard]] virtual bool processImpl(GLuint core_texture, uint16_t core_tex_width, uint16_t core_tex_height) = 0;
        ...
        [[nodiscard]] bool process(GLuint core_texture, uint16_t core_tex_width, uint16_t core_tex_height){
